 ...
 * @author randkill
 */
public class VideoEditWindow extends javax.swing.JFrame {
    ...
    {
        this.Address = directory;
        FileEditReader readF = new FileEditReader(Address , 15);
        this.Name = readF.readline(2);
        jTextFieNameTextFieldld1.setText(Name);
        this.Descriptions = readF.readline(12);
        descriptionTextField.setText(Descriptions);
        this.Address = readF.readline(4);
        directoryTextFieldield12.setText(Address);
        this.Size = Integer.parseInt(readF.readline(3));
        fileSizeTextField.setText(new Integer(Size).toString());
        this.CYear = Integer.parseInt(readF.readline(5));
        creationYearTextField.setText(new Integer(CYear).toString());
        this.CMonth= Integer.parseInt(readF.readline(6));
        creationMonthTextField.setText(new Integer(CMonth).toString());
        this.CDay= Integer.parseInt(readF.readline(7));
        creationDayTextField.setText(new Integer(CDay).toString());
        this.MYear= Integer.parseInt(readF.readline(8));
        managedYearTextField.setText(new Integer(MYear).toString());
        this.MMonth= Integer.parseInt(readF.readline(9));
        managedMonthTextField.setText(new Integer(MMonth).toString());
        this.MDay= Integer.parseInt(readF.readline(10));
        managedDayTextField.setText(new Integer(MDay).toString());
        this.Duration = Integer.parseInt(readF.readline(14));
        durationTextField.setText(new Integer(Duration).toString());
        this.FrameRate = Integer.parseInt(readF.readline(15));
        frameRateTextField.setText(new Integer(FrameRate).toString());
        String tp;
        tp = readF.readline(11);
        ...
        else if (gn =="documantry") {
            Genre = Genre.DOCUMANTRY;
            gCombo = 5;
        }
        else if (gn == "sciencefiction") {
            Genre = Genre.SCIENCEFICTION;
            gCombo = 6;
        }
        genreComboBox.setSelectedIndex(gCombo);
