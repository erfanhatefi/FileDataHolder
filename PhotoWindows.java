 ...
 * @author randkill
 */
public class PhotoWindows extends javax.swing.JFrame {
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try{
            fileSizeTextField.getText();
            Size = Integer.parseInt(fileSizeTextField.getText());
            String le =lenghtTextField.getText();
            String w =widthTextField.getText();

            this.lenght = Integer.parseInt(le);
    ...
    private void lenghtTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        this.lenght = Integer.parseInt(lenghtTextField.getText());
    }
