 ...
 * @author randkill
 */
public class AudioEditWindow extends javax.swing.JFrame {
    ...
    {
        Address = directory;
        FileEditReader readF = new FileEditReader(Address , 17);
        ...
        formatComboBox.setSelectedIndex(combo);
        this.Descriptions = readF.readline(4);
        descriptionTextField.setText(Descriptions);
        this.Address = readF.readline(5);
        directoryTextfield.setText(Address);
        this.Size = Integer.parseInt(readF.readline(6));
        fileSizeTextfield.setText(new Integer(Size).toString());
        this.CYear = Integer.parseInt(readF.readline(7));
        creationYearTextfield.setText(new Integer(CYear).toString());
        this.CMonth= Integer.parseInt(readF.readline(8));
        creationMonthTextfield.setText(new Integer(CMonth).toString());
        this.CDay= Integer.parseInt(readF.readline(9));
        creationDayTextfield.setText(new Integer(CDay).toString());
        this.MYear= Integer.parseInt(readF.readline(10));
        managedYearTextfield.setText(new Integer(MYear).toString());
        this.MMonth= Integer.parseInt(readF.readline(11));
        managedMonthTextfield.setText(new Integer(MMonth).toString());
        this.MDay= Integer.parseInt(readF.readline(12));
        managedDayTextfield.setText(new Integer(MDay).toString());
        audioDUrationTextfield.setText(new Integer(Duration).toString());
        this.Artistname= readF.readline(13);
        artistNameTextField.setText(Artistname);
        this.Artistgender= readF.readline(14);
        artistGenderTextfield.setText(Artistgender);
        this.Artistgenre = readF.readline(15);
        Artistgenre = artistGenreTextfield.getText();
        this.Artistage  = Integer.parseInt(readF.readline(16));
        artistAgeTextfield.setText(new Integer(Artistage).toString());
        this.Duration = Integer.parseInt(readF.readline(17));
        audioDUrationTextfield.setText(new Integer(Duration).toString());
    ...
    private void initComponents() {
        ...
        audioDUrationTextfield.setText("seconds");
                                                        ...
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                        ...
                                                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                                                ...
                                                                                .addComponent(selectFileLabel, javax.swing.GroupLayout.Alignment.LEADING)
